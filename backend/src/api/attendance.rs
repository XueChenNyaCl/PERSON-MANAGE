...
pub async fn create(
    ...
    manager
        .require_permission(user_id, "attendance.create")
        .await?;
...
pub async fn update(
    ...
    let manager = PermissionManager::new(pool.clone());
    manager
        .require_permission(user_id, "attendance.update")
        .await?;
...
pub async fn delete(
    ...
    let manager = PermissionManager::new(pool.clone());
    manager
        .require_permission(user_id, "attendance.delete")
        .await?;
